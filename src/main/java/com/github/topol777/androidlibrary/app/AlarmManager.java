...
public class AlarmManager {
    ...
    public static PendingIntent set(Context context, long time, Intent intent) {
        PendingIntent pe = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            pe = createPendingIntent(context, intent, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_IMMUTABLE);
        }
        else
        {
            pe = createPendingIntent(context, intent, PendingIntent.FLAG_ONE_SHOT);
   ...
   ;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            return checkPost(time, intent, createPendingIntent(context, intent, PendingIntent.FLAG_IMMUTABLE) );
        }
        else
        {
